...
void Intersection::addVehicleToQueue(std::shared_ptr<Vehicle> vehicle)
{
    ...
    std::promise<void> prms_allowed_to_enter;
    auto ftr_allowed_to_enter = prms_allowed_to_enter.get_future();
    _waitingVehicles.pushBack(vehicle, std::move(prms_allowed_to_enter));
    ftr_allowed_to_enter.wait();
